    ...
    <div className="bg-white border border-gray-200 rounded-xl">
      <div className="px-4 py-3 border-b border-gray-100 bg-gray-50 rounded-t-xl flex items-center justify-between gap-3">
        <div className="flex-shrink-0">
          <h3 className="text-sm font-semibold text-gray-900">Bucket List</h3>
        ...
        <div className="flex gap-1.5 flex-shrink-0">
          ...
          <button
            ...
            className="px-2.5 py-1 rounded-full text-[10px] font-medium bg-teal-600 text-white hover:bg-teal-700 transition-colors flex items-center gap-0.5"
            title="Add transport"
          >
            <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <Droppable droppableId="droppable-unscheduled">
        {(provided, snapshot) => (
          <div
            ...
            className={`p-3 min-h-[60px] flex flex-wrap gap-2 transition-colors ${
